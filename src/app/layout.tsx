...
export const metadata: Metadata = {
  title: "Vento - Backing Italian Founders Globally",
  description: "Italy's most active non-governmental early-stage fund investing €75M. €150k initial checks with follow-on potential. Sector-agnostic, geography-independent.",
  keywords: "venture capital, Italian startups, early-stage funding, Exor, founder funding",
  metadataBase: new URL("https://www.vento.ventures"),
  alternates: {
    canonical: "https://www.vento.ventures"
  },
  openGraph: {
    title: "Vento - Backing the Best Italian Founders",
    description: "Wholly funded by Exor, investing €75M to empower exceptional Italian founders globally.",
    url: "https://www.vento.ventures",
    siteName: "Vento Ventures",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Vento - Backing Italian Founders Globally",
    description: "Early-stage venture capital fund backed by Exor"
  },
  robots: {
    index: true,
    follow: true
